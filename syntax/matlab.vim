...
syn keyword matlabRepeat		do parfor for while
...
syn keyword matlabOperator		nan inf cell length numel

syn keyword matlabFunction		error warning assert eval function

syn keyword matlabImplicit		abs acos atan asin cos cosh exp log prod sum
syn keyword matlabImplicit		log10 max min sign sin sqrt tan reshape cumsum
syn keyword matlabImplicit		permute arrayfun cellfun eig svd find
